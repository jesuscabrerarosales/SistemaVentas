...
namespace SistemaVentas.Controllers
{
    ...
    public class PedidoesController : ControllerBase
    {
        ...
        public PedidoesController(SistemaVentasContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Pedidos>> PostPedido(Pedidos pedido)
        {
            ...
            return CreatedAtAction("GetPedido", new { id = pedido.NroPedido }, pedido);
        }
        ...
        {
            return _context.Pedidos.Any(e => e.NroPedido == id);
        }
    }
}
